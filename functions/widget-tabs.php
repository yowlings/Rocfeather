...
<?php else: ?>
<a href='<?php the_permalink(); ?>'><img src="<?php echo get_template_directory_uri(); ?>/images/smallthumb.png" alt="<?php the_title(); ?>"  wclass="wp-post-image" /></a>
<?php endif; ?>
<div class="clear"></div>
</div>
 	<div class="info">
 	<p class="entry-title"><a title="<?php the_title(); ?>" href="<?php the_permalink() ?>"><?php the_title(); ?> </a> <br/></p>
	<div class="meta">
    <span><?php the_time('d.m.Y'); ?> by <?php the_author_posts_link(); ?></span>
	</div> <!--end .entry-meta--> 	
	</div> <!--end .info-->
	<div class="readMore readMore2"><a href="<?php the_permalink() ?>"> </a></div>
    <div class="clear"></div>
